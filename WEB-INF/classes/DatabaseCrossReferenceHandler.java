...
public class DatabaseCrossReferenceHandler extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String column1 = jsonRequestObject.get("column1").getAsString();
		String column2 = jsonRequestObject.get("column2").getAsString();
            ...
            if (ds != null) //datasourse exists
            {
                ...
                try ( Connection conn = ds.getConnection() ) {
                	...
                	if(conn != null) 
                    {
                        ...
                        rst = stmt.executeQuery("select " + column1 + ", " + column2 + "from contrs." + tableName); //contains query Contact
